...
function pageLoad() {
  ...
  $(".default-scroller").overlayScrollbars({
  ...
  $(".popup-with-form").magnificPopup({
    ...
    callbacks: {
      ...
      beforeClose: function () {
        ...
        if (
          $.magnificPopup.instance.currItem.inlineElement.find(".rubberBand")
            .length !== 0
        ) {
          if (
            !$.magnificPopup.instance.currItem.inlineElement
              .find(".rubberBand")
              .hasClass("hidden")
          ) {
            ...
            message(
              "You forgot to save",
              "<a class=\"mouse\" onclick=\"$('.popup-with-form').magnificPopup('open'," +
                magIndex +
                ')">Would you like to go back?</a>',
              activeInfo.settings.notifications.position,
              "#FFF",
              "warning",
              "5000"
...
function doneTypingMediaSearch() {
  ...
  organizrAPI2("GET", "api/v2/homepage/" + server + "/search/" + query)
...
$(document).on("click", ".login-button", function (e) {
  ...
  if (check == null) {
    ...
    $("div.login-box").block({
      message:
        '<h5><img width="20" src="plugins/images/busy.gif" /> Just a moment...</h4>',
      css: {
        color: "#fff",
    ...
    organizrAPI2("POST", "api/v2/login", post)
      .success(function (data) {
      ...
      .fail(function (xhr) {
        ...
        console.error(
          "Organizr Function: " + xhr.responseJSON.response.message
        );
        local("r", "loggingIn");
      });
  }
...
$(document).on("click", ".unlockButton", function (e) {
  ...
  organizrAPI2("POST", "api/v2/users/unlock", post)
    .success(function (data) {
...
$(document).on("click", ".register-button", function (e) {
  ...
  console.log(post);
  organizrAPI2("POST", "api/v2/users/register", post)
    .success(function (data) {
      let html = data.response;
      location.reload();
    })
...
$(document).on("click", ".reset-button", function (e) {
  ...
  if (email !== "") {
    ...
    organizrAPI2("POST", "api/v2/users/recover", post)
      .success(function (data) {
...
$(document).on("click", ".editGroupButton", function () {
  $("#edit-group-form [name=group]").val(
    $(this).parent().parent().attr("data-group")
  );
  $("#edit-group-form [name=id]").val(
    $(this).parent().parent().attr("data-id")
  );
  $("#edit-group-form [name=image]").val(
    $(this).parent().parent().attr("data-image")
  );
});
//EDIT GROUP
$(document).on("click", ".editGroup", function () {
  ...
  organizrAPI2("PUT", "api/v2/groups/" + info.id, info, true)
    .success(function (data) {
      try {
...
$(document).on("click", ".changeDefaultGroup", function () {
  ...
  var callbacks = $.Callbacks();
  callbacks.add(buildGroupManagement);
  organizrAPI2("PUT", "api/v2/groups/" + id, { default: 1 }, true)
    .success(function (data) {
      try {
        var response = data.response;
        message(
...
$(document).on("click", ".deleteUserGroup", function () {
  ...
  swal({
    title:
      ...
      el.parent().parent().attr("data-group") +
      "?",
    icon: "warning",
    buttons: {
    ...
    if (willDelete) {
      ...
      var callbacks = $.Callbacks();
      callbacks.add(buildGroupManagement);
      organizrAPI2("DELETE", "api/v2/groups/" + id, null, true)
        .success(function (data) {
          try {
            message(
              "Group Deleted",
...
$(document).on("click", ".addNewGroup", function () {
  ...
  var callbacks = $.Callbacks();
  callbacks.add(buildGroupManagement);
  organizrAPI2("POST", "api/v2/groups", info, true)
    .success(function (data) {
      try {
        var response = data.response;
        $(".groupIconImageList").val(null).trigger("change");
...
$(document).on("click", ".addNewUser", function () {
  ...
  organizrAPI2("POST", "api/v2/users", userInfo, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("click", ".editUserButton", function () {
  $("#edit-user-form [name=username]").val(
    $(this).parent().parent().attr("data-username")
  );
  $("#edit-user-form [name=id]").val($(this).parent().parent().attr("data-id"));
  $("#edit-user-form [name=email]").val(
    $(this).parent().parent().attr("data-email")
  );
});
//EDIT GROUP
$(document).on("click", ".editUserAdmin", function () {
  ...
  var callbacks = $.Callbacks();
  callbacks.add(buildUserManagement);
  organizrAPI2("PUT", "api/v2/users/" + userInfo.id, userInfo, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change", ".userGroupSelect", function () {
  ...
  var callbacks = $.Callbacks();
  callbacks.add(buildUserManagement);
  organizrAPI2("PUT", "api/v2/users/" + id, { group_id: groupId }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("click", ".deleteUser", function () {
  ...
  swal({
    title:
      window.lang.translate("Delete ") +
      user.parent().parent().attr("data-username") +
      "?",
    icon: "warning",
    buttons: {
      cancel: window.lang.translate("No"),
    ...
    if (willDelete) {
      ...
      var callbacks = $.Callbacks();
      callbacks.add(buildUserManagement);
      organizrAPI2("DELETE", "api/v2/users/" + id, null, true)
        .success(function (data) {
          message(
            "User Deleted",
            "",
...
$(document).on("change", ".tabGroupSelectMax", function (event) {
  ...
  var groupID = $(this).find("option:selected").val();
  var callbacks = $.Callbacks();
  organizrAPI2("PUT", "api/v2/tabs/" + id, { group_id_max: groupID }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change", ".tabGroupSelectMin", function (event) {
  ...
  var groupID = $(this).find("option:selected").val();
  var callbacks = $.Callbacks();
  organizrAPI2("PUT", "api/v2/tabs/" + id, { group_id: groupID }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change", ".tabCategorySelect", function () {
  ...
  var callbacks = $.Callbacks();
  organizrAPI2("PUT", "api/v2/tabs/" + id, { category_id: categoryID }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change", ".tabTypeSelect", function () {
  ...
  var callbacks = $.Callbacks();
  organizrAPI2("PUT", "api/v2/tabs/" + id, { type: type }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change", ".enabledSwitch", function () {
  ...
  var callbacks = $.Callbacks();
  organizrAPI2("PUT", "api/v2/tabs/" + id, { enabled: enabled }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change", ".splashSwitch", function () {
  ...
  var callbacks = $.Callbacks();
  organizrAPI2("PUT", "api/v2/tabs/" + id, { splash: splash }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change", ".pingSwitch", function () {
  ...
  var callbacks = $.Callbacks();
  organizrAPI2("PUT", "api/v2/tabs/" + id, { ping: ping }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change", ".preloadSwitch", function () {
  ...
  var callbacks = $.Callbacks();
  organizrAPI2("PUT", "api/v2/tabs/" + id, { preload: preload }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change", ".addToAdminSwitch", function () {
  ...
  var callbacks = $.Callbacks();
  organizrAPI2("PUT", "api/v2/tabs/" + id, { add_to_admin: data }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change", ".defaultSwitch", function () {
  ...
  var callbacks = $.Callbacks();
  organizrAPI2("PUT", "api/v2/tabs/" + id, { default: 1 }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("click", ".deleteTab", function () {
  ...
  swal({
    title:
      window.lang.translate("Delete ") +
      tab.parent().parent().attr("data-name") +
      "?",
    icon: "warning",
    buttons: {
      cancel: window.lang.translate("No"),
    ...
    if (willDelete) {
      ...
      organizrAPI2("DELETE", "api/v2/tabs/" + id, null, true)
        .success(function (data) {
          message(
            "Tab Deleted",
            "",
...
$(document).on("click", ".editTab", function () {
  ...
  if (
    (typeof tabInfo.url == "undefined" || tabInfo.url == "") &&
    (typeof tabInfo.url_local == "undefined" || tabInfo.url_local == "")
  ) {
    message(
      "Edit Tab Error",
      " Please set a Tab URL or Local URL",
      activeInfo.settings.notifications.position,
      "#FFF",
      "warning",
      "5000"
  ...
  if (
    checkIfTabNameExists(tabInfo.name) &&
    originalTabNameLower !== tabNameLower
  ) {
    message(
      "Edit Tab Error",
      " Tab name already used",
      activeInfo.settings.notifications.position,
      "#FFF",
      "warning",
      "5000"
  ...
  if (tabInfo.id !== "" && tabInfo.tabName !== "" && tabInfo.tabImage !== "") {
    var callbacks = $.Callbacks();
    callbacks.add(buildTabEditor);
    organizrAPI2("PUT", "api/v2/tabs/" + tabInfo.id, tabInfo, true)
      .success(function (data) {
        try {
          var response = data.response;
        } catch (e) {
...
$(document).on("click", ".addNewTab", function () {
  ...
  tabInfo["order"] =
    parseInt(
      $("#tabEditorTable").find("tr[data-order]").last().attr("data-order")
    ) + 1;
  ...
  if (
    tabInfo.order !== "" &&
    tabInfo.name !== "" &&
    (tabInfo.url !== "" || tabInfo.url_local !== "") &&
    tabInfo.image !== ""
  ) {
    var callbacks = $.Callbacks();
    callbacks.add(buildTabEditor);
    organizrAPI2("POST", "api/v2/tabs", tabInfo, true)
      .success(function (data) {
        try {
          var response = data.response;
...
$(document).on("click", ".addNewCategory", function () {
  ...
  categoryInfo["order"] =
    parseInt(
      $("#categoryEditorTable").find("tr[data-order]").last().attr("data-order")
    ) + 1;

  if (
    typeof categoryInfo.category == "undefined" ||
    categoryInfo.category == ""
  ) {
    message(
      "Edit Tab Error",
      " Please set a Category Name",
      activeInfo.settings.notifications.position,
      "#FFF",
      "warning",
      "5000"
  ...
  if (categoryInfo.category !== "" && categoryInfo.image !== "") {
    ...
    organizrAPI2("POST", "api/v2/categories", categoryInfo, true)
      .success(function (data) {
        try {
          var response = data.response;
...
$(document).on("click", ".deleteCategory", function () {
  ...
  swal({
    title:
      window.lang.translate("Delete ") +
      category.parent().parent().attr("data-name") +
      "?",
    icon: "warning",
    buttons: {
      cancel: window.lang.translate("No"),
    ...
    if (willDelete) {
      ...
      var callbacks = $.Callbacks();
      callbacks.add(buildCategoryEditor);
      organizrAPI2("DELETE", "api/v2/categories/" + id, null, true)
        .success(function (data) {
          message(
            "Category Deleted",
            "",
...
$(document).on("click", ".editCategoryButton", function () {
  $("#edit-category-form [name=category]").val(
    $(this).parent().parent().attr("data-name")
  );
  $("#edit-category-form [name=image]").val(
    $(this).parent().parent().attr("data-image")
  );
  $("#edit-category-form [name=id]").val(
    $(this).parent().parent().attr("data-id")
  );
});
//EDIT CATEGORY
$(document).on("click", ".editCategory", function () {
  ...
  if (
    ...
    organizrAPI2(
      "PUT",
      "api/v2/categories/" + categoryInfo.id,
      categoryInfo,
      true
    )
      .success(function (data) {
...
$(document).on("click", ".changeDefaultCategory", function () {
  ...
  var callbacks = $.Callbacks();
  callbacks.add(buildCategoryEditor);
  organizrAPI2("PUT", "api/v2/categories/" + id, { default: 1 }, true)
    .success(function (data) {
      try {
        var response = data.response;
      } catch (e) {
...
$(document).on("change keydown", ".addFormTick :input", function (e) {
  ...
  if ($(this).hasClass("themeChanger")) {
    organizrAPI2("GET", "api/v2/themes")
      .success(function (data) {
        try {
          let response = data.response;
...
$(document).on("click", ".deleteImage", function () {
  ...
  swal({
    title:
      window.lang.translate("Delete ") + image.attr("data-image-name") + "?",
    icon: "warning",
    buttons: {
      cancel: window.lang.translate("No"),
      confirm: window.lang.translate("Yes"),
    ...
    if (willDelete) {
      var post = {
        ...
        messageTitle: "",
        messageBody:
          window.lang.translate("Deleted Image") +
          ": " +
      ...
      organizrAPI2("DELETE", post.api, "", true)
        .success(function (data) {
          try {
            var response = data.response;
          } catch (e) {
...
$(document).on("click", ".enablePlugin", function () {
  ...
  organizrAPI2("PUT", "api/v2/config", data, true)
    .success(function (data) {
      try {
        message(
          "Plugin Enabled",
...
$(document).on("click", ".disablePlugin", function () {
  ...
  swal({
    title:
      window.lang.translate("Disable") +
      " " +
      plugin.attr("data-plugin-name") +
      "?",
    icon: "warning",
    buttons: {
      cancel: window.lang.translate("No"),
...
$(document).on("click", ".testPath", function () {
  ...
  if (typeof path == "undefined" || path == "") {
    ...
    organizrAPI2("POST", "api/v2/test/path", { path: path })
      .success(function (data) {
        var html = data.response;
        message(
          "Path",
...
$(document).on("click", ".playlist-filter li>a", function () {
  ...
  $(".playlist-previous").attr(
    "onclick",
    "owlChange('" + button + "','previous');"
  );
});
// refresh cache image
...
$(document).on("click", ".metadata-get", function (e) {
  ...
  ajaxloader(".content-wrap", "in");
  organizrAPI2("POST", "api/v2/homepage/" + source + "/metadata", { key: key })
    .success(function (data) {
      let response = data.response;
      $("." + uid + "-metadata-info").html("");
      $("." + uid + "-metadata-info").html(
        buildMetadata(response.data, source)
      );
      $("." + uid).trigger("click");
...
$(document).on("click", ".downloader", function (e) {
  ...
  organizrAPI2("POST", api, { target: target })
    .success(function (data) {
...
$(document).on("click", ".testTab", function () {
  ...
  if (input.val() !== "") {
    ...
    organizrAPI2("POST", "api/v2/test/iframe", post)
      .success(function (data) {
        let html = data.response;
...
$(document).on("click", ".newAPIKey", function () {
  ...
  $("#settings-main-form [name=organizrAPI]")
    .val(newCode)
    .change()
    .parent()
    .find(".clipboard")
    .attr("data-clipboard-text", newCode);
});
// purge log
$(document).on("click", ".purgeLog", function () {
  ...
  if (logId) {
    ...
    organizrAPI2("DELETE", post.api, "", true)
      .success(function (data) {
        loadSettingsPage2(
          "api/v2/page/settings_settings_logs",
...
$(document).on("click", ".delete-backup", function () {
  $("#settings-settings-backup").block({
    message:
      '<p style="margin:0;padding:8px;font-size:24px;" lang="en">Deleting Backup...</p>',
    css: {
      color: "#fff",
...
$(document).on(
  "change",
  "#choose-calender-filter, #choose-calender-filter-status",
  function (e) {
  ...
  switch (type) {
    case "tabs":
      ...
      var items = [
        {
          title: "Name",
          body: "The text that will be displayed for that certain tab",
        },
        {
          title: "Category",
          body: "Each Tab is assigned a Category, the default is unsorted.  You may create new categories on the Category settings tab",
        },
        {
          title: "Group",
          body: "The lowest Group that will have access to this tab",
        },
        {
          title: "Type",
          body: "Internal is for Organizr pages<br/>iFrame is for all others<br/>New Window is for items to open in a new window",
        },
        {
          title: "Default",
          body: "You can choose one tab to be the first opened tab on page load",
        },
        { title: "Active", body: "Either mark a tab as active or inactive" },
        {
          title: "Splash",
          body: "Toggle this to add the tab to the Splash Page on page load",
        },
        {
          title: "Ping",
          body: "Enable Organizr to ping the status of the local URL of this tab",
        },
        {
          title: "Preload",
          body: "Toggle this tab to loaded in the background on page load",
        },
      ];
...
$(document).on(
  "keyup",
  "#authBackendHostPrefix-input, #authBackendHostSuffix-input",
  function () {
    var newDN =
      $("#authBackendHostPrefix-input").val() +
      "TestAcct" +
      $("#authBackendHostSuffix-input").val();
...
$(document).on("click", ".ipInfo", function () {
  organizrAPI2("GET", "api/v2/ip/" + $(this).text())
    .success(function (data) {
      try {
        let response = data.response.data;
        var region =
          typeof response.region == "undefined" ? " N/A" : response.region;
        var ip = typeof response.ip == "undefined" ? " N/A" : response.ip;
        var hostname =
          typeof response.hostname == "undefined" ? " N/A" : response.hostname;
        ...
        var country =
          typeof response.country == "undefined" ? " N/A" : response.country;
        var phone =
          typeof response.phone == "undefined" ? " N/A" : response.phone;
        var div =
          '<div class="row">' +
          '<div class="col-lg-12">' +
          '<div class="white-box">' +
          ...
          '<table class="table">' +
          "<tbody>" +
          '<tr><td class="text-left">Hostname</td><td class="txt-oflo text-right">' +
          hostname +
          "</td></tr>" +
          '<tr><td class="text-left">Location</td><td class="txt-oflo text-right">' +
          loc +
          "</td></tr>" +
          '<tr><td class="text-left">Org</td><td class="txt-oflo text-right">' +
          org +
          "</td></tr>" +
          '<tr><td class="text-left">City</td><td class="txt-oflo text-right">' +
          city +
          "</td></tr>" +
          '<tr><td class="text-left">Country</td><td class="txt-oflo text-right">' +
          country +
          "</td></tr>" +
          '<tr><td class="text-left">Phone</td><td class="txt-oflo text-right">' +
          phone +
          "</td></tr>" +
          '<tr><td class="text-left">Region</td><td class="txt-oflo text-right">' +
          region +
          "</td></tr>" +
          "</tbody>" +
          "</table>" +
        ...
        .success(function (data) {
          try {
            ...
            if (typeof response.backdrops !== "undefined") {
              ...
              $("." + target + "-metadata-info .user-bg").css(
                "background-image",
                ""
              );
              setTimeout(function () {
...
$(document).on("click", ".log-details", function () {
  ...
  organizrAPI2("GET", "api/v2/log/all/" + trace)
    .success(function (data) {
      try {
        let response = data.response;
...
$(document).on("click", ".toggle-donation-history", function () {
  ...
  if (status === "hidden") {
    ...
    organizrAPI2("GET", "api/v2/homepage/donate")
      .success(function (data) {
        try {
          let response = data.response;
          if (response.data) {
            $.each(response.data, function (i, v) {
              ...
              let user =
                activeInfo.user.groupID == 0
                  ? "&nbsp; <code>" + v.email + "</code>"
                  : "";
              info +=
                '<li><div class="bg-primary"><i class="fa fa-usd text-white"></i></div> ' +
                v.date +
                user +
            ...
            info =
              '<ul class="feeds fc-scroller" style="height: 250px">' +
              info +
              "</ul>";
          } else {
            info = "No history...";
        ...
        let html =
          '<div class="white-box"><h3 class="box-title" lang="en">Recent Donations</h3>' +
          info +
          "</div>";
